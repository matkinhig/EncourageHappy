...
class DataQuotes {
    ...
    static var authors : [String] = ["Tèo","Tý","Sửu","Dần","Mão","Thìn","Ngọ","Mùi","Tuất"]
    ...
    [
        " Hãy chậm rãi trong việc chọn bạn và càng chậm rãi trong việc thay bạn.","Hãy đếm tuổi của bạn bằng số bạn bè chứ không phải số năm. Hãy đếm cuộc đời bạn bằng nụ cười chứ không phải bằng nước mắt.",
    ...
    static func getQuotes (type : Int, index : Int) -> String{ //quote, author
        return quotes[type][index]
    }
    
    static func getAuthors (index : Int) -> String {
        return authors[index]
    }
    
    static func countQuote ( type : Int ) -> Int {
